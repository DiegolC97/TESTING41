...
export function Hero() {
  return (
    <>
      ...
      <main id="adventure" tabIndex={-1} className="mx-auto w-full max-w-site px-page outline-none">
        ...
        <div className="flex flex-col justify-between gap-6 border-t py-7 sm:flex-row sm:items-center">
          <p className="flex items-center gap-3 text-eyebrow font-semibold uppercase text-muted-foreground"><span className="flex size-9 items-center justify-center rounded-full border"><ArrowDown className="size-4 text-foreground" aria-hidden="true" /></span>A little curiosity. Endless possibility.</p>
        ...
        <p className="pb-6 text-center text-xs leading-relaxed text-muted-foreground">A fan-made demo, inspired by a world we love. Pokémon belongs to Nintendo, Creatures & GAME FREAK.</p>
      </main>
    </>
  );
}
